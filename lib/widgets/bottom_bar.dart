...
import 'package:tiktokmusic/utils/tik_tok_icons_icons.dart';
            ...
            children: [
              ...
              Expanded(
                child:
                    ...
                    // children: [
                    // SizedBox(),
                    menuButton('Music', Icons.my_library_music_outlined, 4),
                // customCreateIcon,
                // SizedBox()
                // ],
              ),
              ...
              Icon(icon,
                  color: GetIt.instance<FeedViewModel>().actualScreen == 0
                      ...
                      : GetIt.instance<FeedViewModel>().actualScreen == index
                          ...
                          : Colors.black54,
                  size:
                      index == 4 ? NavigationIconSize + 5 : NavigationIconSize),
              SizedBox(
                height: 7,
              ),
              Text(
